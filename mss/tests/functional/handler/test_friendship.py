...
class FriendshipHandlerTestCase(AsyncHTTPTestCase):
    ...
    def test_get_friendship(self):
        ...
        self.assertEqual(response.body, '{"friend": [{"username": "test_get_friendship-2", "gender": "M", "first_name": "test_get_friendship-2", "last_name": "test_get_friendship-2"}, {"username": "test_get_friendship-3", "gender": "M", "first_name": "test_get_friendship-3", "last_name": "test_get_friendship-3"}]}')
